...
namespace razor_web.Areas.Identity.Pages.Account
{
    ...
    public class ExternalLoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetCallbackAsync(string returnUrl = null, string remoteError = null)
        {
            ...
            {
                // có tài khoản, chưa liên kết => lien kết tài khoản với dịch vụ ngoài
        ...
        public async Task<IActionResult> OnPostConfirmationAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //Claim Đặn tính mô tả 1 đối tượng
                if(info.Principal.HasClaim(c => c.Type == ClaimTypes.Email)){
                ...
                if(registeredUser == null && externalEmailUser != null){
                    ModelState.AddModelError(string.Empty, "Không hỗ trợ tạo tài khoản mới - có Email khác với Email ở dịch vụ ngoài");
                    return Page();
                }
                
                if(externalEmail == Input.Email && externalEmailUser == null){
                    //Chưa có account -> tạo tk mới, liên kết, Đn
